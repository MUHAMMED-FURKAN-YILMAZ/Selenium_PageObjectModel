...
public class C01_E2ETest2 {
    ...
    public void roomCreateTest() throws InterruptedException {
        ...
        Thread.sleep(2000);
        Assert.assertTrue(qaConcortPage.addRoomSuccessfulText.isDisplayed());

        //10. OK butonuna tıklayın.
        qaConcortPage.addRoomAlertOkButton.click();
        ...
        Assert.assertTrue(qaConcortPage.addRoomHotelRoomListText.isDisplayed());
