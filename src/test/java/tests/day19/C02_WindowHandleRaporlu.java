...
public class C02_WindowHandleRaporlu extends TestBaseRapor {
    ...
    public void testReusableMethod(){
        ...
        extentTest.pass("test edecegimiz yazi locate edildi");

        Assert.assertFalse(newWindowYaziElementi.isDisplayed());// hata mesaji icin false yaptik ve raporun yaninda ss de aliyor
